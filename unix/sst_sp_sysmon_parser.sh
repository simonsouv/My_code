...
printf "date;time;dataserver;version;user_percent;system_percent;io_percent;idle_percent;ctx_switch_cache_search_miss;ctx_switch_exceedint_IO;ctx_switch_system_disk;ctx_switch_Last_log_page_write;ctx_switch_IO_device_contention;ctx_switch_network_packet_received;ctx_switch_network_packet_sent;housekeeper_wash_dirty;ulc_flush_by_full_ulc;minimally_logged_ulc_flush_by_full_ulc;ulc_log_semaphore_wait;ulc_semaphore_wait;all_caches_hit;all_caches_miss;all_caches_buffer_grabbed_dirty;all_caches_large_io_denied_pool_too_small;all_caches_large_io_effectiveness;def_data_cache_hit;def_data_cache_hit_in_wash;def_data_cache_miss;def_data_cache_large_io_denied_pool_too_small;def_data_cache_large_io_used;stmt_cached;stmt_found;stmt_not_found;stmt_dropped;max_outstanding_io;io_delay_structure_io;io_delay_server_config;io_delay_engine_config;io_delay_os_config;network_IO_delayed;Avg_bytes_input_per_packet;Avg_bytes_output_per_packet;full_ulc_count;minimally_logged_full_ulc_count\n" > ${RESULT_FILE}
